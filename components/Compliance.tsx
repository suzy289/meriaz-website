...
export default function Compliance() {
  ...
  return (
    <section className="py-20 lg:py-32 relative overflow-hidden">
      <div className="absolute inset-0 bg-gradient-to-b from-green-900/10 via-transparent to-blue-900/10"></div>
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          <h3 className="text-2xl font-bold text-white mb-8">Certifications et Standards</h3>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {[
              ...
              <div key={cert.name} className="bg-white/5 rounded-xl p-4">
                <div className="text-white font-bold text-lg mb-2">{cert.name}</div>
                <div className="text-green-400 text-sm">{cert.description}</div>
              </div>
            ))}
          </div>
        </motion.div>
